#!/bin/zsh
# FIXME: this script should setup airflow for you. It currently doesnt work; I have tried with #!/bin/bash as well...
export AIRFLOW_HOME="${PWD}/airflow"
export AIRFLOW_CONFIG="${AIRFLOW_HOME}/airflow/airflow.cfg"
